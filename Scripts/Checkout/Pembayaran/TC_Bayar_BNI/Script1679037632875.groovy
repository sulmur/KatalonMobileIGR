...
'Pilih opsi \'Virtual Account BNI\''
Mobile.tap(findTestObject('Checkout/Pembayaran/VA BNI'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'VA BNI.png', FailureHandling.CONTINUE_ON_FAILURE)
