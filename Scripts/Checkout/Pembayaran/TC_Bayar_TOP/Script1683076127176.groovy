...
'Pilih opsi \'Term of Payment\''
Mobile.tap(findTestObject('Checkout/Pembayaran/TOP'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'TOP.png', FailureHandling.CONTINUE_ON_FAILURE)
