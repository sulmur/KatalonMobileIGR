...
Mobile.tap(findTestObject('Checkout/Pembayaran/Bayar Tunai'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Bayar Tunai.png', FailureHandling.CONTINUE_ON_FAILURE)
