...
Mobile.tap(findTestObject('Checkout/Pembayaran/Bayar Sekarang'), 0)

Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'i-saku.png', FailureHandling.CONTINUE_ON_FAILURE)
