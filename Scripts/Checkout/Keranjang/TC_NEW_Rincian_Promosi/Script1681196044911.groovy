...
'Tap "Detail Hadiah"'
Mobile.tap(findTestObject('Checkout/Keranjang/Rincian Promosi/Detail Hadiah'), 0)

Mobile.delay(1, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('Detail Hadiah.png', FailureHandling.CONTINUE_ON_FAILURE)

'Tap tombol "Cancel" Detail Hadiah'
Mobile.tap(findTestObject('Checkout/Keranjang/Rincian Promosi/Cancel Detail Hadiah'), 0)
