...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Keranjang di bawah 150000.png', FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Keranjang di atas 150000.png', FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Pengiriman di atas 150000.png', FailureHandling.CONTINUE_ON_FAILURE)
