...
Mobile.callTestCase(findTestCase('Checkout/Keranjang/TC_Pesan_Ulang'), [:], FailureHandling.STOP_ON_FAILURE)
...
'Tap icon \'-\''
Mobile.waitForElementPresent(findTestObject('Checkout/Keranjang/Kurangi Produk'), 0)
...
'Tap icon \'+\''
Mobile.waitForElementPresent(findTestObject('Checkout/Keranjang/Tambah Produk'), 0)
...
Mobile.callTestCase(findTestCase('Checkout/Keranjang/TC_Hapus_Produk'), [:], FailureHandling.STOP_ON_FAILURE)
