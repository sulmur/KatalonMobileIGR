...
Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/Indopaket Mobil NEXTDAY'), 0)

'Tap opsi pengiriman \'Nextday Mobil\''
Mobile.tap(findTestObject('Checkout/Pengiriman/Indopaket Mobil NEXTDAY'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Potongan Nextday Mobil.png', FailureHandling.CONTINUE_ON_FAILURE)
