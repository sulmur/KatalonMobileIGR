...
if (Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/Indopaket Motor SAMEDAY'), 0)) {
    Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/Indopaket Motor SAMEDAY'), 0)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Potongan Sameday Motor.png', FailureHandling.CONTINUE_ON_FAILURE)
