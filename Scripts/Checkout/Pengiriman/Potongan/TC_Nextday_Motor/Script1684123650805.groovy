...
Mobile.tap(findTestObject('Checkout/Keranjang/Rincian Promosi/Panah Ke atas Rincian Promosi'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
if (Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/Indopaket Motor NEXTDAY'), 0)) {
    Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/Indopaket Motor NEXTDAY'), 0)

    'Tap opsi pengiriman \'Nextday Motor\''
    Mobile.tap(findTestObject('Checkout/Pengiriman/Indopaket Motor NEXTDAY'), 0)
} else {
    Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/Indopaket Motor NEXTDAY'), 0)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Potongan Nextday Motor.png', FailureHandling.CONTINUE_ON_FAILURE)
