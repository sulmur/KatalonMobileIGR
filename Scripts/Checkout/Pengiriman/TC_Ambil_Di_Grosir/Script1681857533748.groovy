...
'Tap opsi pengiriman \'Ambil di Grosir\''
Mobile.tap(findTestObject('Checkout/Pengiriman/Ambil di Toko'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Ambil di Grosir.png', FailureHandling.CONTINUE_ON_FAILURE)
