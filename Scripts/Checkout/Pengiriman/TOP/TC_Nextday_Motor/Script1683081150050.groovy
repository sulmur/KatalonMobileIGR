...
Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/TOP/NEXTDAY Motor TOP'), 0)

'Tap opsi pengiriman \'Nextday Motor\''
Mobile.tap(findTestObject('Checkout/Pengiriman/TOP/NEXTDAY Motor TOP'), 0)

'Tap tombol \'Pembayaran\''
Mobile.tap(findTestObject('Checkout/Pembayaran/Tombol Pembayaran'), 0)

Mobile.delay(6, FailureHandling.OPTIONAL)
