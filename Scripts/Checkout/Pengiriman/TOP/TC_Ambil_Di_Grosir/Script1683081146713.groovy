...
Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/TOP/Ambil_di_Toko_TOP'), 0)

'Tap opsi pengiriman \'Ambil di Grosir\''
Mobile.tap(findTestObject('Checkout/Pengiriman/TOP/Ambil_di_Toko_TOP'), 0)
