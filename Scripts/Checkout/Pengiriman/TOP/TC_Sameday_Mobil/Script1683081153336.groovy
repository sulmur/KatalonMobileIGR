...
Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/TOP/SAMEDAY Mobil TOP'), 0)

'Tap opsi pengiriman \'Sameday Mobil\''
Mobile.tap(findTestObject('Checkout/Pengiriman/TOP/SAMEDAY Mobil TOP'), 0)
