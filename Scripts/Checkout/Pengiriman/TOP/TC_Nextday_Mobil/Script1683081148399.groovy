...
Mobile.waitForElementPresent(findTestObject('Checkout/Pengiriman/TOP/NEXTDAY Mobil TOP'), 0)

'Tap opsi pengiriman \'Nextday Mobil\''
Mobile.tap(findTestObject('Checkout/Pengiriman/TOP/NEXTDAY Mobil TOP'), 0)
