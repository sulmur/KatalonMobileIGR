...
Mobile.setText(findTestObject('Lupa_Password/Field Email'), 'raihansulthan4@gmail.com', 0)

'Input email yang terdaftar'
Mobile.setText(findTestObject('Lupa_Password/Field Email Aktif'), 'raihansulthan4@gmail.com', 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Cek Email benar.png', FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Cek Berhasil Kirim Lupa Password.png', FailureHandling.CONTINUE_ON_FAILURE)
