...
'Input \'Password Baru\' dengan data berkarakter angka saja'
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Password Baru'), 'aeHFOx8jV/A=', 0)
...
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Konfirmasi Password Baru'), 'aeHFOx8jV/A=', 0)
