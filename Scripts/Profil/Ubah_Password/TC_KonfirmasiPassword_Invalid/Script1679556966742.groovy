...
'Input \'Ketik Ulang Password Baru\' dengan data yang berbeda dengan \'Password Baru\''
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Konfirmasi Password Baru'), 'RMXzmiOoakwpR9NeVo+OxQ==', 
    0)
