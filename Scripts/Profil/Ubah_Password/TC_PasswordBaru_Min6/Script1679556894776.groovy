...
'Input \'Password Baru\' dengan data dibawah 6 karakter'
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Password Baru'), '4qQFvqdikLY=', 0)
...
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Konfirmasi Password Baru'), '4qQFvqdikLY=', 0)

'Tap icon \'Mata tertutup\''
Mobile.tap(findTestObject('Profil/Ubah_Password/Icon Konfirmasi Password Baru'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Cek Password di bawah 6 karakter.png', FailureHandling.CONTINUE_ON_FAILURE)