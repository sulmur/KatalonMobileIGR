...
'Input \'Password Baru\' dengan data yang valid'
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Password Baru'), 'cVIwjfOa1J4=', 0)
...
Mobile.setEncryptedText(findTestObject('Profil/Ubah_Password/Field Konfirmasi Password Baru'), 'cVIwjfOa1J4=', 0)

'Tap icon \'Mata tertutup\''
Mobile.tap(findTestObject('Profil/Ubah_Password/Icon Konfirmasi Password Baru'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Cek Password.png', FailureHandling.CONTINUE_ON_FAILURE)
