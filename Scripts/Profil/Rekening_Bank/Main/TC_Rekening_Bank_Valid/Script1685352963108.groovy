...
Mobile.callTestCase(findTestCase('Profil/Rekening_Bank/TC_RekeningBank_Button'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profil/Rekening_Bank/TC_RekeningBank_PilihBank'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profil/Rekening_Bank/TC_RekeningBank_Cabang'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profil/Rekening_Bank/TC_RekeningBank_Norek'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Profil/Rekening_Bank/TC_RekeningBank_NamaRekeningValid'), [:], FailureHandling.STOP_ON_FAILURE)
...
if (Mobile.waitForElementPresent(findTestObject('Profil/Rekening_Bank/Submit/Setuju Simpan Rekening'), 0)) {
    ...
    Mobile.takeScreenshot('Reports/Gagal Simpan Rekening 2.png')
