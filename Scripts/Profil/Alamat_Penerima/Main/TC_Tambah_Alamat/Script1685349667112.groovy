...
Mobile.callTestCase(findTestCase('Profil/Alamat_Penerima/Tambah Alamat/TC_Alamat_Lengkap_Valid'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.waitForElementPresent(findTestObject('Profil/Alamat_Penerima/Tambah Alamat/Tutup Berhasil Tambah Alamat'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Berhasil Tambah Alamat.png', FailureHandling.CONTINUE_ON_FAILURE)

'Tap tombol \'Tutup\' pada pop-up berhasil tambah alamat'
Mobile.tap(findTestObject('Profil/Alamat_Penerima/Tambah Alamat/Tutup Berhasil Tambah Alamat'), 0)
