...
Mobile.setText(findTestObject('Profil/Alamat_Penerima/Tambah Alamat/Field Nama Penerima'), 'Puja', 0)
...
'Tap field \'Provinsi\''
Mobile.tap(findTestObject('Profil/Alamat_Penerima/Edit Alamat/Opsi Alamat/Dropdown Provinsi'), 0)
...
'Tap field \'Kota\''
Mobile.tap(findTestObject('Profil/Alamat_Penerima/Edit Alamat/Opsi Alamat/Dropdown Kota'), 0)
...
'Tap field \'Kecamatan\''
Mobile.tap(findTestObject('Profil/Alamat_Penerima/Edit Alamat/Opsi Alamat/Dropdown Kecamatan'), 0)
...
'Tap field \'Kelurahan\''
Mobile.tap(findTestObject('Profil/Alamat_Penerima/Edit Alamat/Opsi Alamat/Dropdown Kelurahan'), 0)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Cek Pop-up berhasil ubah alamat.png', FailureHandling.CONTINUE_ON_FAILURE)

'Pastikan muncul pop-up berhasil ubah alamat'
Mobile.verifyElementExist(findTestObject('Profil/Alamat_Penerima/Edit Alamat/Pop-up berhasil ubah alamat'), 0)

'Tap \'Tutup\' pada pop-up berhasil ubah alamat'
Mobile.tap(findTestObject('Profil/Alamat_Penerima/Edit Alamat/Tutup Pop-up Berhasil ubah alamat'), 0)
