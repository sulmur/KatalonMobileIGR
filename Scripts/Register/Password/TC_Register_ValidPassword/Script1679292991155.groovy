...
'Tap \'Konfirmasi Password\''
Mobile.tap(findTestObject('Register/Password/Field Konfirmasi Password - Register'), 0)

'Input Konfirmasi Password yang sesuai dengan Password yang telah diinput'
Mobile.setEncryptedText(findTestObject('Register/Password/Field Konfirmasi Password - Register'), 'lsdNNXlVAZI=', 0)

'Tap icon \'Mata tertutup\' pada field Konfirmasi Password'
