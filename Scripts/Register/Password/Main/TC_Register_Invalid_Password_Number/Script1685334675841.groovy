...
'Input Password dengan angka saja'
Mobile.setEncryptedText(findTestObject('Register/Password/Field Password - Register'), 'aeHFOx8jV/A=', 0)
...
Mobile.setEncryptedText(findTestObject('Register/Password/Field Konfirmasi Password - Register'), 'aeHFOx8jV/A=', 0)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Invalid Password Only Number.png', FailureHandling.CONTINUE_ON_FAILURE)
