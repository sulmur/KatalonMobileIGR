...
'Input Password dibawah 6 karakter'
Mobile.setEncryptedText(findTestObject('Register/Password/Field Password - Register'), 'yVvBGCXjhlM=', 0)
...
Mobile.setEncryptedText(findTestObject('Register/Password/Field Konfirmasi Password - Register'), 'yVvBGCXjhlM=', 0)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Invalid Character Password.png', FailureHandling.CONTINUE_ON_FAILURE)
