...
Mobile.tap(findTestObject('Object Repository/Register/Password/Icon Field Password'), 
    0)
...
'Tap icon \'Mata tertutup\''
Mobile.tap(findTestObject('Object Repository/Register/Password/Icon Field Konfirmasi Password'), 
    0)
