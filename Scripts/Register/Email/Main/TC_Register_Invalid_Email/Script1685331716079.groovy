...
Mobile.callTestCase(findTestCase('Register/Email/TC_Register_InvalidEmail'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.waitForElementPresent(findTestObject('Register/Email/Alert Email tidak valid'), 0)

'Pastikan muncul alert "Email tidak valid!"'
Mobile.verifyElementVisible(findTestObject('Object Repository/Register/Email/Alert Email tidak valid'), 0)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Invalid Email Result.png', FailureHandling.CONTINUE_ON_FAILURE)
