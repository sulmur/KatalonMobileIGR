...
'Tap field Nama'
Mobile.tap(findTestObject('Register/Name/Field Nama - Register'), 0)

'Input Nama di bawah 3 karakter'
Mobile.setText(findTestObject('Register/Name/Field Nama - Register'), 'si', 0)
...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Invalid Name Result.png', FailureHandling.CONTINUE_ON_FAILURE)
