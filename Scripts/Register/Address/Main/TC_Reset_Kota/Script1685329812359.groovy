...
Mobile.tap(findTestObject('Object Repository/Register/Address/Register_ResetAddress/Dropdown Kota -Kabupaten Tangerang-'), 
    0)

'Pilih \'Kota\' yang berbeda dari sebelumnya'
Mobile.tap(findTestObject('Object Repository/Register/Address/Register_ResetAddress/Opsi Kota -Kabupaten Pandeglang-'), 
    0)
