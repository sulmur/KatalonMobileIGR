...
'Tap kembali field \'Kecamatan\' yang sudah dipilih'
Mobile.tap(findTestObject('Object Repository/Register/Address/Register_ResetAddress/Dropdown Kecamatan -Cisauk-'), 0)

'Pilih \'Kecamatan\' yang berbeda dari sebelumnya'
Mobile.tap(findTestObject('Object Repository/Register/Address/Register_ResetAddress/Opsi Kecamatan -Balaraja-'), 0)
