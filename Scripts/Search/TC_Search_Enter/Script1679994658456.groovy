...
Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Search Success.png', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Search/Back Search'), 0)

Mobile.delay(2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot(RunConfiguration.getReportFolder() + 'Back Search.png', FailureHandling.CONTINUE_ON_FAILURE)
